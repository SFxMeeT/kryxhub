package com.kryxhub.kryxhub.user.entity;
...
public class UserEntity {
    ...
    private List<LinkedSocialAccountEntity> socialAccounts = new ArrayList<>();
    ...
    private List<SupportTicketEntity> supportTickets = new ArrayList<>();
    ...
    public void addSocialAccount(LinkedSocialAccountEntity account) {
        socialAccounts.add(account);
        account.setUser(this);
    }

    public void removeSocialAccount(LinkedSocialAccountEntity account) {
    ...
    public com.kryxhub.kryxhub.user.enums.PrimaryPersona getPrimaryPersona() {
    ...
    public List<LinkedSocialAccountEntity> getSocialAccounts() {
