...
import com.kryxhub.kryxhub.dto.LinkedAccountsResponseDto;
...
public class LinkedAccountService {
    ...
    public String unlinkAccount(UUID accountId, String userEmail) {
        ...
        com.kryxhub.kryxhub.entity.LinkedSocialAccountEntity account = linkedAccountRepository.findById(accountId)
